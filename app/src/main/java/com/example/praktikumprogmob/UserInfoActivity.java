...
public class UserInfoActivity extends AppCompatActivity {
    private TextInputLayout layoutName, layoutAge;
    private TextInputEditText txtName, txtAge;
    ...
    private void init() {
        ...
        layoutAge = findViewById(R.id.txtLayoutAgeUserInfo);
        txtName = findViewById(R.id.txtNameUserInfo);
        txtAge = findViewById(R.id.txtAgeUserInfo);
